              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
				  <form class="form-inline">
					...
					<select class="custom-select col-lg-3" id="Select1">
					...
					<select class="custom-select col-lg-3" id="Select2">
					...
					<select class="custom-select col-lg-3" id="Select3">
					...
					<select class="custom-select col-lg-3" id="Select4">
